	...
	<view class="gt_content">
		<u-form :model="form" ref="uForm" label-width="auto" :border-bottom="false">
			...
			<u-form-item label="满足金额" required prop="coupon_price">
				<view class="row">
					<u-input v-model="params.coupon_min_price" type="digit" border placeholder="金额" class="uni-input" @input="(e)=>inputChange(e, 1)" />
					<view class="msg">减</view>
					<u-input v-model="params.coupon_price" type="digit" border placeholder="金额" @input="(e)=>inputChange(e, 2)"  />
				</view>
			</u-form-item>
			...
			<u-form-item label="有效日期" required prop="time">
				<u-input :value="params.time" border disabled placeholder="请选择" @click="show = true" class="time" />
			</u-form-item>
