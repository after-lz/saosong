						...
						<view class="con_val">
							<view class="con_input">
								...
								<u-input v-model="item.pca" type="select" height="80" placeholder="请选择所在城市" disabled
									:clearable="false" @click="showPCA(index)"></u-input>
							</view>
						</view>
					</view>
	...
	export default {
		...
		methods: {
			...
			confirmArea(e) {
				...
				gt.arriveStationList[index].provinceStr = e[0].label;
				// gt.arriveStationList[index].provinceCode = e[0].value;
				gt.arriveStationList[index].cityStr = e[1].label;
				// gt.arriveStationList[index].cityCode = e[1].value;
				gt.arriveStationList[index].areaStr = e[2].label;
				// gt.arriveStationList[index].areaCode = e[2].value;
				gt.arriveStationList[index].pca = e[0].label + '-' + e[1].label + '-' + e[2].label;
