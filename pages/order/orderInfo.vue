<template>
	<view class="gt_content">
			...
			<scroll-view :scroll-y="scrollY" class="scroll">
								...
								<view class="con_list">
									<view class="con_item" v-for="(item,index) in unPayBillList" :key="index">
										...
										<view class="con_voucher" v-if="item.fee_pic">
											...
											<view class="con_list">
												<view class="con_img" v-for="(item1,index1) in item.picArr" :key="index1"
													@click="gtCommon.previewImg(item1 + '?x-oss-process=style/sansong_app')">
													<image :src="item1 + '?x-oss-process=style/sansong_app'" mode="widthFix"></image>
												</view>
											</view>
										</view>
									</view>
				...
				<view class="con_userInfo_contact">
					...
					<view class="con_contact">
						...
						<view class="con_call" @click="call_show = true">
						...
						<view class="con_fromTo">
							...
							<view class="con_right">
								...
								<view class="con_fromNamePhone">
									...
									<text style="margin-left: 10rpx">{{gtCommon.hiddenMobile4to7(dataInfo.pickup_mobile)}}</text>
								</view>
								...
								<view class="con_toNamePhone">
									...
									<text style="margin-left: 10rpx">{{gtCommon.hiddenMobile4to7(dataInfo.receive_mobile)}}</text>
								</view>
							</view>
						</view>
						<view class="con_line">
							...
							<view class="con_item">
								...
								<view class="con_val">
									<view class="con_text_btn">
										...
										<view class="con_copyBtn" @click="gtCommon.copyStr(dataInfo.waybill_sn)" v-if="dataInfo.waybill_sn">
											<text>复制</text>
										</view>
									</view>
								</view>
							...
							<view class="con_item">
								...
								<view class="con_val">
									<view class="con_text_btn">
										...
										<view class="con_copyBtn" @click="gtCommon.copyStr(dataInfo.deliver_sn)">
											<text>复制</text>
										</view>
									</view>
								</view>
				...
				<view class="con_goodsInfo">
					<u-read-more :toggle="true" close-text="更多" open-text="收起" color="#909399" text-indent="0">
						...
						<view class="con_imgs" v-if="dataInfo.pack_imgs">
							...
							<view class="con_list">
								<view class="con_item" v-for="(item,index) in dataInfo.pack_imgs" :key="index"
									...
									<image :src="item + '?x-oss-process=style/sansong_app'" mode="widtahFix"></image>
								</view>
							</view>
						</view>
						<view class="con_nums">
						...
						<view class="con_keyVal">
							...
							<view class="con_item" v-if="dataInfo.peisong_type == 2 && dataInfo.status > 7 && dataInfo.outlets_name != ''">
								<view class="con_key">
									<view class="con_text">
										<text>自提网点</text>
									</view>
								...
								<view class="con_val">
									...
									<view class="con_text">
										<text>电话：</text>
										<text style="color:#485EF4" @click="gtCommon.callMobile(dataInfo.outlets_mobile)">{{dataInfo.outlets_mobile}}</text>
									</view>
								</view>
							</view>
							<view class="con_item">
						...
						<view class="con_item" v-if="sendInfo.waybill_sn">
							...
							<view class="con_val">
								<view class="con_text_btn">
									...
									<view class="con_copyBtn" @click="gtCommon.copyStr(sendInfo.waybill_sn)" v-if="sendInfo.waybill_sn">
										<text>复制</text>
									</view>
								</view>
							</view>
							...
							<view class="trajectoryItem" v-for="(item,index) in trajectoryList" :key="index">
								<view class="con_icon_title">
									...
									<view class="con_text">
										...
										<text style="margin-left: 40rpx;font-size: 28rpx;font-family: PingFangSC-Regular, PingFang SC;font-weight: 400;color: #909399;line-height: 40rpx;">
											{{gtCommon.formateTime(item.create_time, 'YYYY年MM月DD日HH:mm:ss')}}
										</text>
									</view>
								</view>
		...
		<u-popup v-model="call_show" mode="bottom" border-radius="14">
			<view class="call_pop">
				<view class="call_title">选择电话联系人</view>
				<view class="call_card">
					<view class="call_bag">推荐联系人</view>
					<view class="call_info">
						<view class="info_user">下单人({{ cargoInfo.nickname }})</view>
						<view class="info_btn">
							<u-button type="primary" @click="gtCommon.callMobile(cargoInfo.mobile)">拨打</u-button>
						</view>
					</view>
					<view class="call_remark">下单人也是发货人</view>
				</view>
				<view class="call_other">其他联系人</view>
				<view class="call_item">
					<view class="item_left">
						<view class="item_user">发货人({{ dataInfo.pickup_truename }})</view>
						<view class="item_address">地址：{{dataInfo.pickup_city + dataInfo.pickup_county + dataInfo.pickup_address}}</view>
					</view>
					<view class="item_right" @click="gtCommon.callMobile(dataInfo.pickup_mobile)">
						<u-image :src="gtCommon.getOssImg('order/phone.png')" mode="widthFix"></u-image>
					</view>
				</view>
				<view class="call_item">
					<view class="item_left">
						<view class="item_user">收货人({{ dataInfo.receive_truename }})</view>
						<view class="item_address">地址：{{dataInfo.receive_city + dataInfo.receive_county + dataInfo.receive_address}}</view>
					</view>
					<view class="item_right" @click="gtCommon.callMobile(dataInfo.receive_mobile)">
						<u-image :src="gtCommon.getOssImg('order/phone.png')" mode="widthFix"></u-image>
					</view>
				</view>
			</view>
