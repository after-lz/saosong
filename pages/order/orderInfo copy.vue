<template>
	<view class="gt_content">
		...
		<!-- #ifdef MP-WEIXIN -->
		<view class="con_map" v-if="eCover">
			<map id="myMap" style="width:750rpx;height:100vh;" :markers="covers" :polyline="polyline"
				...
				<cover-view slot="callout">
					...
					<cover-view class="con_cover" :marker-id="sCover.id">
						<cover-view class="con_item">
							<cover-image class="con_img" :src="sCover.img" @load="scoverImgLoad" @error="scoverImgFail"></cover-image>
						</cover-view>
						<cover-view class="con_item" style="margin-left: -20rpx;padding-left: 20rpx;z-index:-99" v-if="sCover.text">
							<cover-view class="con_text">{{sCover.text}}</cover-view>
						</cover-view>
					</cover-view>

					<cover-view class="con_cover" :marker-id="eCover.id" v-if="eCover.img">
						<cover-view class="con_item">
							<cover-image class="con_img" :src="eCover.img" @load="ecoverImgLoad" @error="ecoverImgFail"></cover-image>
						</cover-view>
						<cover-view class="con_item" style="margin-left: -20rpx;padding-left: 20rpx;" v-if="eCover.text">
							<cover-view class="con_text">{{eCover.text}}</cover-view>
						</cover-view>
					</cover-view>
				</cover-view>
			</map>
											...
											<view class="con_list">
												<view class="con_item" v-for="(item,index) in payBillList" :key="index">
													...
													<view class="con_payMethod">
														...
														<view class="con_text">
															<text v-if="item.fee_type == 1">线下支付</text>
															<text v-if="item.fee_type == 2">余额支付</text>
															<text v-if="item.fee_type == 3">支付宝支付</text>
															<text v-if="item.fee_type == 4">微信支付</text>
														</view>
													</view>
													<view class="con_voucher" v-if="item.fee_pic">
														<view class="con_text">
