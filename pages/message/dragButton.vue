...
<script>
	export default {
		...
		computed: {
			// getHeight() {
			// 	let safeArea = uni.getStorageSync("safeArea")
			// 	let topHeight = safeArea.top + 44
			// 	let viewHeight = safeArea.height - topHeight
			// 	return `height: ${viewHeight}px;top: ${topHeight}px;`
			// }
		},
		methods: {
			getSysInfo() {
