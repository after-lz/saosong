<template>
	<view class="u-checkbox" :style="[checkboxStyle]" v-if="inversion">
		<view class="u-checkbox__label u-checkbox__Ilabel" @tap="onClickLabel" :style="{
	...
	<view class="u-checkbox" :style="[checkboxStyle]" v-else>
		<view class="u-checkbox__icon-wrap" @tap="toggle" :class="[iconClass]" :style="[iconStyle]">
			<u-icon class="u-checkbox__icon-wrap__icon" name="checkbox-mark" :size="checkboxIconSize"
				:color="iconColor" />
		</view>
