<template>
	<view class="sign">
		<view class="imgBox">
			<view class="nom_img" @click="signModShow=true" v-if="!showImg">
				<!-- <image v-if="!showImg" src="/static/other/sign_icon.png" mode="widthFix"
					>
				</image> -->
				<text>请点此签名</text>
			</view>
			...
			<view class="across_img" v-if="showImg">
				...
				<image v-if="showImg" :src="showImg" style="width: 660rpx;height:300rpx;overflow:hidden;" mode="aspectFit" @click="previewCanvasImg(showImg)">
				</image>
			</view>
		</view>
				...
				<view class="signBox" @tap.stop>
					<view class="wrapper">
						...
						<view class="handCenters">
							<canvas :canvas-id="canvasIds" :style="{width:100+'vh',height:75 +'vw'}"></canvas>
						</view>
